...
fn open_file() {
    tauri::api::dialog::message("Hello from Rust", "Hello World!").unwrap();
    let mut options = tauri::api::dialog::OpenDialogOptions::new();
    ...
    let result = tauri::api::dialog::open(options).unwrap();
