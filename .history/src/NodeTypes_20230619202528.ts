...
// These interfaces are going to be used to create objects that will be used to create the AST (should we use an AST or just compile directly from the DAG?)
// 