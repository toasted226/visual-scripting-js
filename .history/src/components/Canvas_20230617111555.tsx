    ...
    return (
        <div className="canvas">
            ...
            onDragMove={drawGrid}>
                ...
                <Layer>
                    <Rect width={50} height={50} x={300} y={300} fill='red' draggable perfectDrawEnabled={true} />
                    <Rect width={50} height={50} x={5000} y={300} fill='blue' draggable perfectDrawEnabled={true} />
                </Layer>
            </Stage>
        </div>
    )
